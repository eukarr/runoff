...
# сохраняем текущую рабочую папку и устаналиваем рабочую папку курса
# для воспроизведения скрипта при проверке нужно установить свою рабочую директорию!
old_dir <- getwd()
...
# Загрузка, изучение структуры и диагностика исходных данных.-------------------------------------------------------------
#-------------------------------------------------------------------------------------------------------------------------
...
# завершение работы, возвращаем старые значения измененных параметров-----------------------------------------------------
# ------------------------------------------------------------------------------------------------------------------------
